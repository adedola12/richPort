    ...
    >
      ...
      >
        <div className="flex flex-col gap-4 max-w-[520px]">
          ...
          <div className="space-y-3 text-sm leading-6 text-neutral-200 sm:text-[15px]">
  ...
  return (
    <section className="relative w-full bg-[#050505] py-16 lg:py-24">
      <div className="mx-auto max-w-[1200px] px-4 lg:px-6">
        <TypingText
          as="p"
          text="Here are a few things I've done over the years..."
          className="text-center text-xs font-medium text-white/75 sm:text-sm"
          delay={0.1}
        />
